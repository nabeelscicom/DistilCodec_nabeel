...
class MultiScaleSTFTDiscriminator(nn.Module):
    ...
    def __init__(self,
                 msstft_config: dict = None,
                 **kwargs):
        
        super().__init__()
        
        self.msstft_config = msstft_config
        if self.msstft_config is None:
            filters = 32
            in_channels = 1
            out_channels = 1
            ...
            filters = self.msstft_config['filters']
            in_channels = self.msstft_config['in_channels']
            out_channels = self.msstft_config['out_channels']
            n_ffts = self.msstft_config['n_ffts']
            hop_lengths = self.msstft_config['hop_lengths']
            win_lengths = self.msstft_config['win_lengths']
